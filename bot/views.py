                    ...
                    if 'attachments' in message['message']:
                        for attachment in message['message']['attachments']:
                            if attachment['type']=='location':
                                ...
                                elements = []
                                element = Element(title="Costo por fraccion", image_url="https://s3-us-west-2.amazonaws.com/cuadra-apps/Art9.png", subtitle="Art.9")
                                elements.append(element)
                                bot.send_generic_message(user.fb_user, elements)
...
def askAutoContext(message): 
    ...
    post_facebook_message(sender,"'Si el agente pide revisar e interior de tu auto o la cajuela, este sólo podrá hacerlo si tiene una orden judicia'")
